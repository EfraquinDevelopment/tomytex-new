...
export const metadata: Metadata = {
  title: "TOMYTEX | Telas Deportivas en Buenos Aires, Flores | Local de Telas",
  description:
    "Descubre TOMYTEX, el local líder en telas deportivas en Buenos Aires, Flores. Telas de alta calidad para indumentaria deportiva, fitness y más. ¡Visítanos hoy!",
  keywords:
  ...
  robots: "index, follow",
  openGraph: {
    title: "TOMYTEX | Telas Deportivas en Buenos Aires, Flores",
    description:
